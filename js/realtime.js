...
var Realtime = function() {
	...
	var orgId = "z19foh "; // your org ID
	var deviceType = "vcSensor"; // your device Type
	var deviceId = "vcSensor1"; // Your device ID

	var deviceToken = "@Fp6(hIjMLc8ywMZDM"; // Your device Token
